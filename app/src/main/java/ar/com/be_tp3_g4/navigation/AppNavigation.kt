...
fun AppNavigation() {
    ...
    NavHost(
        ...
        composable<NavDestinations.Onboarding> {
            OnboardingScreen(
                onClick = { /*navController.navigate(NavDestinations.Login)*/ },    //aca le paso onClick a la scree de welcome, para que al apretar el boton me lleve a la screen siguiente
            )
        }
    }
}